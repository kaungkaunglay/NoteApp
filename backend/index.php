...
<?php
    ...
    $data = CRUD:: Select("note",null);
    

    if(isset($_GET['deleteSuccess']) && $_GET['deleteSuccess'] == 1 ) {
        echo "<script>alert('Successfully deleted!')</script>";
    }
    elseif(isset($_GET['deleteError']) && $_GET['deleteError'] == 1) {
        echo "<script>alert('No record!')</script>";
    }
    else if(isset($_POST['edit_id'])){
        // perform click 
        $id = $_POST['edit_id'];
        echo "<script>window.location.href='index.php?id=$id#new-note1';</script>";
    }
...
<!-- Mirrored from templates.iqonic.design/note-plus/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jan 2024 10:19:11 GMT -->
<?php require "includes/head.php"; ?>
  ...
  <body class="noteplus-layout  ">
          ...
          <div class="data-scrollbar" data-scroll="1">
              ...
              <div class="sidebar-btn dropdown mb-3">
                  ...
                  <div class="dropdown-menu w-100 border-0 py-3" aria-labelledby="dropdownMenuButton01">
                      <a class="dropdown-item mb-2" href="page-new-note5d2b.php">
                        ...
                        <div class="iq-tab-content">
                            ...
                            <div class="note-content tab-content">                                
                                <div id="note1" class="tab-pane fade active show">
                                    ...
                                    <?php require "includes/cardTable.php"; ?>

                                </div>
                                
                                <?php require "includes/shareNote.php"; ?>

                                <?php require "includes/pinNote.php"; ?>
                                
                                <?php require "includes/favouriteNote.php"; ?>
                            </div> 
                        </div>
                    </div>
                </div>
    ...
    <?php require "includes/modalView.php" ?> 
        ...
        <?php require "includes/modalEdit.php"; ?>
...
<!-- Mirrored from templates.iqonic.design/note-plus/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jan 2024 10:19:36 GMT -->
</html>
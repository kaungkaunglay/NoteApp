...
<?php
    ...
    if(isset($_POST['save'])){
        ...
        $reminder_date = htmlentities($_POST['reminder_date']);
    ...
    if(empty($title) || is_numeric($title)){
        ...
        echo "<script>alert ('Please enter a priority')</script>";
    }
    else {
        CRUD:: Insert("note", ["Title" => $title, "Description" => $description, "Date" => $reminder_date, "Priority" => $priority]);
    }
?>
...
<!-- Mirrored from templates.iqonic.design/note-plus/html/backend/page-new-note.html?type=blank by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jan 2024 10:19:45 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/dripicons/2.0.0/webfont.css">  </head>
                            ...
                            <div class="col-md-8">
                                <form action="#" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" placeholder="Example Note" value="" data-change="input" data-custom-target="#note-title" require>
                                    </div>
                                    <div class="form-group">
                                        <label class="label-control" for="description">Description</label>
                                        <textarea type="text" class="form-control" name="description" id="description" rows="3" data-change="input" data-custom-target="#note-description" placeholder="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." require></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="label-control" for="reminder_date">Reminder Date</label>
                                        <input type="date" class="form-control" name="reminder_date" id="reminder_date" data-change="input" data-custom-target="#note-reminder-date" require>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select name="priority" id="priority" class="form-control" data-change="select" data-custom-target="color" require>
                                    ...
                                    <button type="reset" name="reset" class="btn btn-outline-primary" data-reset="note-reset">

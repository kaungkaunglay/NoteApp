...
<!-- Mirrored from templates.iqonic.design/note-plus/html/backend/ui-badges.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jan 2024 10:19:47 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <div class="card card-block topnav-left">
                  <div class="card-body d-flex align-items-center">
                      <div class="d-flex justify-content-between">
                          <h4 class="text-capitalize">Badge</h4>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <h3 class="mt-2">Example heading <button type="button" class="btn btn-success">

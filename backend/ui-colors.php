...
<!-- Mirrored from templates.iqonic.design/note-plus/html/backend/ui-colors.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jan 2024 10:19:47 GMT -->
<head>
    <meta charset="utf-8">
         ...
         <div class="row">
            ...
            <div class="col-lg-6">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">NotePlus Text Color</h4>
                     </div>
                  </div>
                  <div class="card-body">

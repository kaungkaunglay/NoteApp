...
<!-- Mirrored from templates.iqonic.design/note-plus/html/backend/ui-breadcrumb.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jan 2024 10:19:47 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <div class="card card-block topnav-left">
                  <div class="card-body d-flex align-items-center">
                      <div class="d-flex justify-content-between">
                          <h4 class="text-capitalize">Breadcrumb</h4>
                      </div>
                  </div>
              </div>
